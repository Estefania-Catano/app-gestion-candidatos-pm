...
const Login = () => {
  ...
  function singIn(e) {
    e.preventDefault()
    if (user === "" || password === "") return alert("Login and password are required")
    if (user === "admin" && password === "admin") return alert("Login successful")
    if (user !== "admin" || password !== "admin") return alert("Login failed")
  }
  return (
